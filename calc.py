...
button_equal = Button(root, text="=", padx=40, pady=20, bg="white", command=button_equal)
button_clear = Button(root, text="Clear", padx=30, pady=20, bg="white", command=button_clear)

button_add = Button(root, text="+", padx=40, pady=20,command=button_add)
button_subtract = Button(root, text="-", padx=40, pady=20,command=button_subtract)
button_multipyly = Button(root, text="*", padx=40, pady=20,command=button_multiply)
...
button_multipyly.grid(row=2, column=3)
